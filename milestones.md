...
---
_(Future Milestones Beyond M5: Full-scale project analysis on >1MLoC codebases, GNN integration for learning on Holoform graphs, User Studies (RQ3.2), deeper multi-language implementation (RQ2.2), IDE integration, advanced dynamic analysis integration, etc.)_